...
public final class RuimRecords extends IccRecords {
    ...
    RuimRecords(UiccCardApplication app, Context c, CommandsInterface ci) {
        super(app, c, ci);
        ...
        public void onRecordLoaded(AsyncResult ar) {
            ...
            try {
                ...
                case UserData.ENCODING_7BIT_ASCII:
                    spn =  new String(spnData, 0, numBytes, "US-ASCII");
                    break;
    ...
    public int getVoiceMessageCount() {
        ...
        //C.S0023-D_v1.0 does not have a file id in UIM for MWI
        Log.d(LOG_TAG, "RuimRecords:getVoiceMessageCount - NOP for CDMA");
        return 0;
    }
